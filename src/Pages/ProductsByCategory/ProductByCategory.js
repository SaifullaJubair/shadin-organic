          ...
          {products.length === 0 ? (
            ...
            <div>
              <h3 className="text-gray-800 font-semibold text-lg">
                Total {searchData.length} products{" "}
              </h3>
              <div>
                <div className="mb-2 block">
                  <Label
                    name="search"
                    value="Search Products by Name or Category or Color or Price or ID"
                ...
                <TextInput
                  ...
                  type="text"
                  placeholder="Search Products by Name or Category or Color or Price or ID"
                  className="max-w-xl w-11/12"
                />
              </div>
              <div className="grid xl:grid-cols-4 lg:grid-cols-3  md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6 mt-4">
