        ...
        <div className=" w-full p-6  bg-gray-100">
          {products.length === 0 ? (
            ...
            <div>
              ...
              <div>
                <div className="mb-2 block">
                  <Label name="search" className="text-gray-800 text-lg ">
                    Search product by name or category or color or price or id
                  </Label>
                </div>
                <TextInput
                  id="search"
              ...
              <div className="grid lg:grid-cols-3  xl:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 lg:gap-6 md:gap-4 gap-6 mt-6">
